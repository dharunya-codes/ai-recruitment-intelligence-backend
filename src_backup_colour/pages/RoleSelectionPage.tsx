...
import { UserCheck, Briefcase, ArrowRight, CheckCircle2, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
        ...
        <div
          ...
          className="bg-white rounded-2xl border-2 border-slate-200/80 hover:border-indigo-600 p-8 cursor-pointer transition-all duration-200 shadow-xs hover:shadow-lg flex flex-col justify-between group"
        >
          <div>
            <div className="w-14 h-14 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-xl mb-6 border border-indigo-100 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
            ...
            <p className="text-sm font-medium text-indigo-900/80 mt-1 mb-4 italic">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            <button
              type="button"
              className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-indigo-600 text-white font-bold text-xs group-hover:bg-indigo-700 transition-colors shadow-xs"
            >
