...
export const CandidateDashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-indigo-900 via-indigo-800 to-slate-900 rounded-2xl p-6 sm:p-8 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-md">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-300 mt-1 max-w-xl leading-relaxed">
            ...
            <strong className="text-white underline decoration-indigo-400 underline-offset-2">
              {targetRole}
            </strong>{' '}
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
          ...
          <Link
            to="/interview"
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-500 hover:bg-indigo-400 text-white text-xs font-bold transition-all shadow-md shadow-indigo-950/50"
          >
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs font-semibold text-indigo-600">6 Required</span>
            </div>
            <p className="text-xs text-slate-500 mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Quick Action Hub */}
        <div className="bg-gradient-to-br from-indigo-50/80 to-violet-50/80 rounded-2xl border border-indigo-100 p-6 flex flex-col justify-between">
          <div>
            ...
            <div className="p-3 rounded-xl bg-white/90 border border-indigo-100 text-xs mb-4">
          ...
          <Link
            to="/interview"
            className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs transition-colors shadow-xs"
          >
            <Mic className="w-4 h-4" />
