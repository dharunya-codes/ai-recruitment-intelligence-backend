  ...
  return (
    <div className="space-y-20 pb-16">
      ...
      <section className="relative overflow-hidden pt-12 sm:pt-20">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-gradient-to-tr from-indigo-200/40 via-violet-200/30 to-teal-100/30 rounded-full blur-3xl -z-10 pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5">
            <Link
              to="/role-selection"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-indigo-600 text-white font-bold text-sm hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-all hover:scale-[1.01]"
            >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs hover:border-indigo-300 transition-all">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs hover:border-indigo-300 transition-all">
            ...
            <Link
              to="/interview"
              className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-violet-600 hover:text-violet-800"
            >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="bg-gradient-to-br from-indigo-900 to-slate-900 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden">
