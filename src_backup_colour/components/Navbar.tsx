      ...
      <div className="flex items-center justify-between gap-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-600 to-violet-600 text-white flex items-center justify-center shadow-xs shadow-indigo-200 group-hover:scale-105 transition-transform">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 bg-white text-slate-700 text-xs font-semibold hover:border-indigo-300 hover:bg-indigo-50/40 transition-all shadow-2xs"
          ...
          {isLoggedIn ? (
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-1 text-xs font-semibold px-3 py-1.5 rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 transition-colors"
            >
