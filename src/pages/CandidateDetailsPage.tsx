      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-6 sm:p-8 shadow-xs">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-slate-100">
          <div className="flex items-start sm:items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-red-600 to-red-800 text-white font-extrabold text-2xl flex items-center justify-center shadow-md">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <div className="p-3 rounded-xl bg-red-50 border border-red-100 text-center min-w-[100px]">
        ...
        <div className="mt-6 p-4 rounded-xl bg-red-50/50 border border-red-100/90 text-xs">
