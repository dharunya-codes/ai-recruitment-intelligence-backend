  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-red-100 bg-red-50/50 p-4 text-xs text-slate-700">
        <strong className="text-red-700">Analysis target:</strong> {candidateJobDescription.jobTitle} at {candidateJobDescription.companyName}
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-6 sm:p-8 shadow-xs">
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          ...
          <div className="p-3 rounded-xl bg-red-50/60 border border-red-100">
            <span className="text-[11px] font-semibold uppercase text-red-700">ATS Pass Rating</span>
            <p className="text-xl font-bold text-red-900 mt-0.5">A- (82%)</p>
          </div>
        </div>
      </div>
