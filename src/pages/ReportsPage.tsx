      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 no-print">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold transition-all shadow-xs disabled:opacity-50"
          >
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-6 sm:p-10 space-y-8 print:shadow-none print:border-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="w-8 h-8 rounded-lg bg-red-600 text-white flex items-center justify-center font-bold text-xs">
                IQ
              </span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80">
            ...
            <span className="text-2xl sm:text-3xl font-black text-red-700 mt-1 block">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-red-50/60 border border-red-100 text-xs text-slate-700">
            <strong className="block text-red-950 font-bold mb-1">Interviewer Summary:</strong>
