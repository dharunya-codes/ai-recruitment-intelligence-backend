...
export const RecruiterDashboardPage: React.FC = () => {
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-teal-900 via-slate-900 to-red-950 rounded-2xl p-6 sm:p-8 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-md">
        <div>
        ...
        <DashboardCard
          ...
          action={
            <Link
              ...
              className="text-xs font-semibold text-red-600 hover:underline flex items-center justify-between"
            >
                ...
                <tr key={candidate.id} className="hover:bg-slate-50/60 transition-colors">
                  ...
                  <td className="py-3.5 px-5">
                    <div className="flex items-center gap-2 w-28">
                      <span className="font-bold text-red-700 w-8">{candidate.skillMatchPct}%</span>
