...
export const InterviewFeedbackPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-red-950 via-slate-900 to-slate-950 border border-slate-800 rounded-2xl p-6 sm:p-8 text-white shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
          ...
          <Link
            to="/reports"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white text-xs font-bold transition-all shadow-md shadow-red-950/50"
          >
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-md">
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="flex justify-between items-center text-xs mb-1.5">
                  ...
                  <span className="font-bold text-red-400">{cat.score}%</span>
                </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-800/90 p-4 rounded-xl bg-red-950/40 border border-red-900/50 text-xs text-slate-300 leading-relaxed">
