    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-red-600 to-red-800 text-white font-bold text-lg flex items-center justify-center shadow-xs">
            {candidate.name
              .split(' ')
              .map((n) => n[0])
              .join('')}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 my-4 p-3 bg-slate-50/80 rounded-xl border border-slate-100 text-center">
        <div>
          ...
          <p className="text-lg font-bold text-red-700">{candidate.skillMatchPct}%</p>
      ...
      <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 font-semibold text-red-600 hover:text-red-800 hover:underline"
        >
