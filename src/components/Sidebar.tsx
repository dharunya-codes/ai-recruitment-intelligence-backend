    ...
    <>
      ...
      >
        ...
        <div className="pt-4 border-t border-slate-100">
          <div className="p-3.5 rounded-xl bg-gradient-to-br from-red-50/70 to-red-50/70 border border-red-100/80 text-xs">
            <div className="flex items-center gap-1.5 text-red-950 font-bold mb-1">
