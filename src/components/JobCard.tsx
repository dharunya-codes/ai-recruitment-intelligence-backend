...
export const JobCard: React.FC<JobCardProps> = ({ job, className = '', onSelect }) => {
  return (
    <div
      className={`bg-white rounded-xl border border-slate-200/90 p-5 shadow-xs hover:border-red-200 hover:shadow-sm transition-all duration-200 ${className}`}
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <span className="text-[11px] font-semibold uppercase text-red-600 tracking-wider">
            {job.department}
          </span>
        ...
        <div className="text-right shrink-0">
          <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-red-50 border border-red-100 text-red-700 text-xs font-bold">
