...
export const UploadBox: React.FC<UploadBoxProps> = ({
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      {selectedFile ? (
        <div className="p-6 rounded-2xl border-2 border-red-200 bg-red-50/30 flex items-center justify-between gap-4">
        ...
        >
          <div className="w-14 h-14 mx-auto rounded-2xl bg-red-50 text-red-600 flex items-center justify-center mb-4 border border-red-100/80 shadow-xs">
